...
Structured content is stripped before scoring:
code fences, inline code, XML/HTML tags, URLs, file mentions, dotted tokens, quoted lines, image markers, and ANSI escapes never count.
